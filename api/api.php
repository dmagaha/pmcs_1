...
R::setup('sqlite:'.__DIR__.'/pmcs.db');
...
require_once('UsHolidays.php');

require_once('userRoutes.php');
require_once('boardRoutes.php');
require_once('itemRoutes.php');
require_once('insuranceRoutes.php');
require_once('frontDeskRoutes.php');
require_once('teamRoutes.php');
require_once('settingsRoutes.php');
